...
trait WrappingPow {
    fn wrapping_pow (&self, n: u64) -> u64;
}

impl WrappingPow for u64 {
    fn wrapping_pow (&self, n: u64) -> u64 {
        let mut result: u64 = *self;
        for _ in 0..n-1 {
...
fn _good_random_u32 () -> u32 {
    ...
    return ( ((22_695_477_u64*(_fast_random_u32() as u64)).wrapping_pow(2) + 1_u64) % (u32::max_value() as u64) ) as u32;
}
...
fn _fast_random_f32 () -> f32 {
    ...
    return time_now as f32 / 999_999_999_f32;
}
